...
import img3 from "../assets/gall14.jpg";
import img4 from "../assets/gall15.jpg";

export default function PCMCs() {
  return (
    <div className="py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>›</span>
          <span className="text-gray-800 font-semibold">PCMCs</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-center">
          ...
          <div className="pr-0 md:pr-10 pb-6 md:pb-0">
            ...
            <p className="text-[#1a9dbd] font-bold text-sm mb-1">
              PCMC<span className="text-xs align-baseline">'s</span>
            </p>
